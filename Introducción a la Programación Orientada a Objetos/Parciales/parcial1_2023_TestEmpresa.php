<?php
    ...
    $objBici1 = new Bicicleta (11, 89500, 2022, "Fire Bird Plegable Cuadro Acero", 85, true);   //165575 // TOTAL: 909575
    $objBici2 = new Bicicleta (12, 310000, 2021, "Bicicleta Trek Marlin 5 Rodado 29 Talle L", 70, true); // 744000
